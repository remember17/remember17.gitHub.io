 ...
 *
 * Persists choice in localStorage. URL `?lang=zh|en` overrides; first
 * visits follow the browser language.
 *
...
(function () {
  ...
  function applyAll(lang) {
    ...
    document.querySelectorAll('[data-fh-content]').forEach(function (n) {
      var v = pick(parse(n.getAttribute('data-fh-content')), lang);
      if (v != null) n.setAttribute('content', v);
    });
    ...
    document.querySelectorAll('[data-fh-poster]').forEach(function (n) {
      var v = pick(parse(n.getAttribute('data-fh-poster')), lang);
      if (v) n.setAttribute('poster', v);
    });
    ...
    document.querySelectorAll('[data-lang-alt]').forEach(function (n) {
      var v = pick(parse(n.getAttribute('data-lang-alt')), lang);
